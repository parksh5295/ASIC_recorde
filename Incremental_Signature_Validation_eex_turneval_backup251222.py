...
def main(args):
    ...
    try:
        ...
        params_str = f"{params_str_base}_n{args.n_splits}_dom{args.dominant_freq_threshold}{dom_suffix}_turneval"
                    ...
                    def filter_rule_batch(rule_batch):
                        ...
                        if use_batched_normal:
                            ...
                            with multiprocessing.Pool(
                                ...
                                initargs=(normal_data_sub_chunks, normal_min_support_effective, negative_filtering_enabled, negative_filter_threshold)
                            ) as pool:
                            ...
                            with multiprocessing.Pool(
                                ...
                                initargs=(normal_data_in_chunk, normal_min_support_effective, negative_filtering_enabled, negative_filter_threshold)
                            ) as pool:
